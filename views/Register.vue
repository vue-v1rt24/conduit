  ...
  <div class="container page">
    <div class="row">
      <div class="col-md-6 offset-md-3 col-xs-12">
        <h1 class="text-xs-center ng-binding">Регистрация</h1>

        <p class="text-xs-center">
          <RouterLink :to="{name: 'login'}">Есть учетная запись?</RouterLink>
        </p>

        <UIMessage/>

        <form @submit.prevent="registerHandler" class="ng-pristine ng-valid ng-valid-email">
          <fieldset>
...
const registerHandler = async () => {
  try {
    isSubmit.value = true;
    await store.register(formFields);
